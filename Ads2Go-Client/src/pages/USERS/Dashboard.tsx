...
const Dashboard = () => {
  ...
  <div className="relative min-h-screen overflow-hidden">
    ...
    <div className="relative z-10 min-h-screen bg-transparent lg:pl-72 px-4 sm:px-5 lg:pr-5 py-6 lg:p-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 lg:pt-1 pl-14 sm:pl-0">
        <div>
      ...
      <div className="block lg:hidden">
        ...
        <div className="grid grid-cols-1 gap-4 mb-6">
          {/* Ad Performance Overview - Mobile */}
          <div
            className="relative p-4 shadow-xl text-white cursor-pointer
          ...
          >
            <div className="flex justify-between items-start mb-4 gap-3">
              ...
              <div className="relative w-32" onClick={(e) => e.stopPropagation()}>
                <button
                  ...
                  className="flex items-center justify-between w-full text-xs text-black rounded-md pl-6 pr-4 py-2 shadow-md focus:outline-none bg-white/60 gap-2"
                >
                ...
                <AnimatePresence>
                  {showAnalyticsPeriodDropdown && (
                    <motion.div
                      ...
                      className="absolute z-10 top-full mt-2 w-full rounded-md shadow-lg bg-white/60 overflow-hidden"
                    >
            ...
            <div className="grid grid-cols-3 gap-3 mt-4 text-center">
              <div className="bg-[#1b5087]/60 p-3">
                ...
                <p className="text-xs text-gray-300">Total Airtime (Minutes)</p>
              ...
              <div className="bg-[#2876c7]/60 p-3">
                ...
                <p className="text-xs text-gray-300">Total Ad Plays</p>
                <p className="text-xs text-gray-400">{analyticsPeriod === '1d' ? 'Last 24h' : analyticsPeriod === '7d' ? 'Last 7 days' : 'Last 30 days'}</p>
              </div>
              <div className="bg-[#1b5087]/60 p-3">
                <p className="text-xl font-bold">
                ...
                <p className="text-xs text-gray-300">Active Ads</p>
                <p className="text-xs text-gray-400">{analyticsPeriod === '1d' ? 'Last 24h' : analyticsPeriod === '7d' ? 'Last 7 days' : 'Last 30 days'}</p>
              </div>
            </div>
          </div>

          {/* QR Impressions - Mobile */}
          <div
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="relative w-24" onClick={(e) => e.stopPropagation()}>
                <button
                  ...
                  className="flex items-center justify-between w-full text-xs text-black rounded-md pl-4 pr-4 py-2 shadow-md focus:outline-none bg-white gap-2"
                >
                  {qrSelectedPeriod}
                  <ChevronDown
                    size={16}
          ...
          {/* Car Location Heat Map - Mobile */}
          <div className="pt-6" onClick={() => window.location.href = '/detailed-analytics'}>
            <div className="flex flex-col justify-between items-start mb-4 gap-2">
              <h2 className="text-lg font-semibold text-gray-800">Car Location Heat Map</h2>
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
              <div className="bg-red-50 p-3">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs text-red-600">High Traffic Zones</p>
                    <p className="text-base font-bold text-red-700">3</p>
                  </div>
              ...
              <div className="bg-yellow-50 p-3">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs text-yellow-600">Medium Traffic</p>
                    <p className="text-base font-bold text-yellow-700">3</p>
                  </div>
              ...
              <div className="bg-green-50 p-3">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs text-green-600">Low Traffic</p>
                    <p className="text-base font-bold text-green-700">3</p>
                  </div>
      ...
      <div className="hidden lg:block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div
            className="relative p-6 shadow-xl md:col-span-2 text-white cursor-pointer
                       bg-[#1b5087]/60 backdrop-blur-md border border-white/20
                       hover:bg-[#1b5087]/70 transition-all duration-300"
            onClick={() => window.location.href = '/detailed-analytics'}
          >
          ...
          {/* Column 2: QR Impressions - Desktop */}
          <div
            className="relative p-4 shadow-xl cursor-pointer
                      bg-white backdrop-blur-md border border-white/20
                      hover:bg-white transition-all duration-300
          ...
          {/* Column 3: Average Mileage and Notification List - Desktop */}
