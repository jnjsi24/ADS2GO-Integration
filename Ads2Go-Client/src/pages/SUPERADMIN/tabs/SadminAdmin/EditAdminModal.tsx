        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="flex justify-between pt-4">
            ...
            <button
              ...
              className="bg-[#3674B5] text-white px-8 py-3 rounded-md font-semibold hover:bg-[#1b5087] transition-colors shadow-md disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
              Update Admin
            </button>
          </div>
