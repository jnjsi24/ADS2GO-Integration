...
import { ChevronDown, ChevronUp, Mail, Phone, MapPin, User, Briefcase, BarChart2, Truck, Edit, MoreVertical, X, CheckSquare } from 'lucide-react';
...
const ManageUsers: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-8 pl-72 bg-gray-100">
