              ...
              <div className="p-4">
                <div className="flex justify-between items-center mb-3">
                  ...
                  <button
                    ...
                    disabled={
                      connectionStatusLoading ||
                      refreshingConnectionStatus ||
                      !tabletData?.getTabletsByMaterial?.length
                    }
                ...
                {(connectionStatusLoading || refreshingConnectionStatus) ? (
                  ...
                  <div className="text-center py-4">
                    ...
                    <span className="text-sm text-gray-500 mb-2">
                      Use the QR code below to connect a tablet or input connection details manually.
                    </span>
                  </div>
                ) : (() => {
                  ...
                  if (!isConnected)
                    return (
                      <div className="text-center py-4">
                        ...
                        <br />
                        <span className="text-sm text-gray-500 mb-2">
                          Please connect to a tablet first using the QR code below
                        </span>
                      </div>
                    );
                            ...
                            {connectedDevice.lastSeen && (
                              <div className="flex justify-between">
                                ...
                                <span className="text-gray-800">
                                  {new Date(connectedDevice.lastSeen).toLocaleString()}
                                </span>
                              </div>
                            )}
                            {connectedDevice.gps && (
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-700">
                      {tabletData.getTabletsByMaterial[0].carGroupId}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center space-y-4">
                <div className="bg-white p-3 border border-gray-200 rounded-lg">
                  {(() => {
                    ...
                    return (
                      <QRCodeSVG value={JSON.stringify(qrData)} size={150} level="M" includeMargin={true} />
                    );
                  })()}
                </div>
