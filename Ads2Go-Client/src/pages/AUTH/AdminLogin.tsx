    ...
    <div className="min-h-screen flex items-center justify-center relative" style={{ minHeight: '100vh' }}>
      ...
      <div className="relative z-10 w-full px-4 py-6 md:hidden">
        <div className="max-w-md mx-auto">
          <div className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-md p-6 shadow-2xl">
            ...
            <h1 className="text-3xl font-bold text-center mb-6 text-white">Admin Log in</h1>
      ...
      <div className="relative z-10 p-8 sm:p-10 hidden md:flex rounded-md shadow-2xl w-full max-w-md bg-white/20 backdrop-blur-lg border border-white/30">
        <div className="w-full">
          ...
          <h1 className="text-4xl font-bold text-center mb-8 text-white">Admin Log in</h1>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative mt-2">
              <input
                type="email"
              ...
              <label
                ...
                className={`absolute left-0 text-white bg-transparent transition-all duration-200 ${email
                  ...
                  : 'peer-placeholder-shown:top-5 peer-placeholder-shown:text-base peer-placeholder-shown:text-white'} peer-focus:-top-2 peer-focus:text-sm peer-focus:text-white/70 peer-focus:font-bold`}
              >
                Enter your email
              </label>
              {validationErrors.email && (
            ...
            <div className="relative mt-6">
              <input
                ...
                onChange={handlePasswordChange}
                autoComplete="current-password"
                className={`peer w-full pr-8 text-white px-0 pt-8 pb-2 border-b bg-transparent focus:outline-none focus:border-blue-500 focus:ring-0 placeholder-transparent transition ${validationErrors.password ? 'border-red-400' : 'border-gray-300'}`}
                style={{ backgroundColor: 'transparent' }}
              />
              <label
                htmlFor="password-desktop"
                className={`absolute left-0 text-white bg-transparent transition-all duration-200 ${password
                  ? 'top-3 text-sm text-white/70 font-bold'
                  : 'peer-placeholder-shown:top-8 peer-placeholder-shown:text-base peer-placeholder-shown:text-white'} peer-focus:top-3 peer-focus:text-sm peer-focus:text-white/70 peer-focus:font-bold`}
              >
                Enter your password
              </label>
              <button
