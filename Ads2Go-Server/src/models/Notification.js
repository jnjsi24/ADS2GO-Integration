...
const NotificationItemSchema = new mongoose.Schema({
  ...
  category: {
    ...
    enum: [
      // User categories
      'AD_APPROVAL', 'AD_REJECTION', 'AD_CREATED', 'AD_DELETION', 'PAYMENT_CONFIRMATION', 'AD_PERFORMANCE', 'PROFILE_CHANGE', 'AD_RESERVATION_EXPIRING', 'AD_RESERVATION_EXPIRED', 'AD_SCHEDULED', 'AD_STARTED',
      // Driver categories
