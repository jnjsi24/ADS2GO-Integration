...
const NotificationItemSchema = new mongoose.Schema({
  ...
  category: {
    ...
    enum: [
      // User categories
      'AD_APPROVAL', 'AD_REJECTION', 'PAYMENT_CONFIRMATION', 'AD_PERFORMANCE', 'PROFILE_CHANGE', 'AD_RESERVATION_EXPIRING', 'AD_RESERVATION_EXPIRED', 'AD_SCHEDULED', 'AD_STARTED',
      // Driver categories
      ...
      'DEVICE_OFFLINE', 'DEVICE_ONLINE', 'DEVICE_MILESTONE', 'MATERIAL_PERFORMANCE', 'DEVICE_STATUS_CHANGE', 'DAILY_COMPLIANCE_MISSED',
