...
const NotificationItemSchema = new mongoose.Schema({
  ...
  category: {
    ...
    enum: [
      // User categories
      'AD_APPROVAL', 'AD_REJECTION', 'AD_CREATED', 'AD_DELETION', 'PAYMENT_CONFIRMATION', 'AD_PERFORMANCE', 'PROFILE_CHANGE', 'AD_RESERVATION_EXPIRING', 'AD_RESERVATION_EXPIRED', 'AD_SCHEDULED', 'AD_STARTED', 'ADS_PRICING_CHANGE',
      // Driver categories
      'MATERIAL_ASSIGNMENT', 'ROUTE_UPDATE', 'DEVICE_ISSUE', 'DRIVER_STATUS_CHANGE', 'SALARY_RATE_CHANGE',
      ...
      'DEVICE_OFFLINE', 'DEVICE_ONLINE', 'DEVICE_MILESTONE', 'MATERIAL_PERFORMANCE', 'DEVICE_STATUS_CHANGE', 'MATERIAL_STATUS_CHANGE', 'DAILY_COMPLIANCE_MISSED',
      // New admin notification categories
      'AD_CAMPAIGN_STARTED', 'AD_CAMPAIGN_ENDED', 'MATERIAL_ASSIGNED', 'MATERIAL_UNASSIGNED', 'ADMIN_RESPONDED_TO_REPORT', 'NEW_DRIVER_REPORT', 'MATERIAL_PHOTOS_UPLOADED', 'COMPANY_AD_CREATED', 'NEWSLETTER_SENT', 'NEW_ADMIN_CREATED'
    ]
  },
  priority: {
    type: String,
