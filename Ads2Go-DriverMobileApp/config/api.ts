...
const API_CONFIG = {
  // Use environment variable like AndroidPlayerExpo, fallback to localhost
  API_URL: `${EXPO_PUBLIC_API_URL || 'http://localhost:5000'}/graphql`,
  
  // Base URL for REST API calls (without /graphql)
  BASE_URL: EXPO_PUBLIC_API_URL || 'http://localhost:5000',
